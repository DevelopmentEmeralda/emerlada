    ...
    public function index()
    {
      // Konfigurasi email
        $config = [
            ...
            'charset'   => 'utf-8',
            'protocol'  => 'smtp',
            'smtp_host' => 'mail.emeraldaresortofficial.com',
            'smtp_user' => 'fajar.maulana@emeraldaresortofficial.com',  // Email gmail
            'smtp_pass'   => 'emeralda@!',  // Password gmail
            'smtp_crypto' => 'ssl',
            'smtp_port'   => 465,
            'crlf'    => "\r\n",
            'newline' => "\r\n"
        ...
        $this->email->from('myloca.dev@gmail.com', 'Depelopmen');

        // Email penerima
        $this->email->to('fma.fajarmaulana@gmail.com'); // Ganti dengan email tujuan
